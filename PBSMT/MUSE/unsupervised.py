...
# data
parser.add_argument("--src_lang", type=str, default='bora', help="Source language")
...
parser.add_argument("--dis_most_frequent", type=int, default=20000, help="Select embeddings of the k most frequent words for discrimination (0 to disable)")
